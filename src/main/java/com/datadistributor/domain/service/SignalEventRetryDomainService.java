 ...
 */
@Slf4j
public class SignalEventRetryDomainService implements SignalEventRetryUseCase {
  ...
  public SignalEventRetryDomainService(SignalAuditQueryPort signalAuditQueryPort,
